...
good = {'1': {'klav': {'Отклонить вызов': '42', 'Принять вызов': '2'},
              ...
              'text': 'Слыша где-то вдалеке раздражающую мелодию звонка, вы сонно '
                      'открываете глаза, протягивая руку к телефону рядом. - Ох, что '
                      'вчера было… или даже не вчера… Башка раскалывается… Да кто '
                      'это, черт побери, трезвонит в такую рань… Еще и номер '
                      'незнакомый…'},
        ...
        '3': {'klav': {'Идти собираться ': '4'},
              ...
              'text': '- «Звонок завершен»… Странно… Ладно… Ё моё… 10 утра… Какое '
                      ...
                      'успею, – думаете вы'},
        '4': {'klav': {'А кто это там?': '5'}, 'photo': '', 'text': 'Эх, свежо.'},
        ...
        '6': {'klav': {'Погнали, там недалеко кафе есть': '7',
              ...
              'photo': '',
              'text': 'Андрей! Хэй, привет, давно не виделись!\nОго, какие люди! Да, '
        ...
        '7': {'klav': {'Всё так': '8', 'Нет, вы меня слушали?': '8'},
              'photo': '',
              'text': 'И так ваш заказ: картошка и морковка. Верно?'},
        '8': {'klav': {'ЧТО': '9'},
              'photo': '',
        ...
        '11': {'klav': {'Какие новости?': '12'},
               'photo': '',
               'text': 'Уже почти полчаса сидите и ждёте новостей, как бы не опоздать '
                       'в универ, но это уважительная причи.. Тут неожиданно '
                       'выскакивает врач'},
        ...
        '19': {'klav': {'Поспешить': '20'},
               'photo': '',
               'text': 'Но что-то не так. Ладно, пойду в универ, иначе точно '
                       'опоздаю…'},
        ...
        '33': {'klav': {'Танцевальных движений?': '34'},
               'photo': '',
               'text': 'Храбрая сотрудница банка нажала кнопку тревоги, грабители '
                       'заметили это, девушка сделала пару танцевальных движений и '
                       'виновато улыбнулась'},
        '34': {'klav': {'Диско?': '35'},
               'photo': '',
               'text': 'Внезапно появляется музыка, суровые грабители срывают с себя '
        ...
        '44': {'klav': {'Да как это возможно?': '45'},
               'photo': '',
               'text': 'Вы покупаете жетоны, но кассирша неаккуратна и уронила '
                       'монетку на пол'},
        '45': {'klav': {'Что это?': '46'},
               'photo': '',
               'text': 'Кассирша поднимает жетон, а вы замечаете у нее хвостик'},
        ...
        '50': {'klav': {'Какое странное утро': '51'},
               'photo': '',
               'text': 'Спускаясь на эскалаторе, вы задумались о произошедшем.'},
        '51': {'klav': {'Наверное новый подкаст': '52'},
               ...
               'text': 'Вы едете вагоне, думая о своём. Внезапно у всех пассажиров на '
                       ...
                       'перестают двигаться'},
        '52': {'klav': {'Бежать': '53', 'Кривляться': '54'},
               'photo': '',
        ...
        '53': {'klav': {'Выйти из метро': '1'},
               'photo': '',
               'text': 'Банда енотов не заметила персонажа и через 2 минуты ушла, '
        ...
        '61': {'klav': {'С таким-то дневником самоконтроля': '68'},
               'photo': '',
               'text': 'Птеродактиль пытается схватить и съесть вас, но вы успевает '
                       'убежать'},
        ...
        '70': {'klav': {'Начать сначала': '1'},
               ...
               'text': 'Вы слушаете голос в голове. Возвращаетесь к странной птице и '
                       ...
                       'вместе, что только благодаря вашему союзы вы сможете долго '
...
def start(message):
    ...
    sm(who, """Привет
Это небольшое и надеемся забавное приключение было сделано в честь День Рождения ФИПМ
